...
def calculate_ARI_2state(wpli_Base, wpli_Anes, dpli_Base, dpli_Anes ):
        ...
        dPLI_ARI = dPLI_ARI/(average_dpli_Base.shape[0]**2)
...
def calculate_ARI_test3(wpli_Base, wpli_Anes, wpli_Reco, dpli_Base, dpli_Anes, dpli_Reco ):
        ...
        Hub_reco = ((norm_degree_Base - norm_degree_Anes)+(norm_degree_Reco - norm_degree_Anes)-(norm_degree_Base - norm_degree_Reco))
        ...
        Hub_ARI = np.sum(np.abs(Hub_reco));
        # normalize with length of nr_channels
        Hub_ARI = Hub_ARI/average_dpli_Base.shape[0]

        return dPLI_ARI, Hub_ARI

def calculate_ARI_weighted(wpli_Base, wpli_Anes, wpli_Reco, dpli_Base, dpli_Anes, dpli_Reco ):
...
def calculate_norm_ARI(wpli_Base, wpli_Anes, wpli_Reco, dpli_Base, dpli_Anes, dpli_Reco ):
