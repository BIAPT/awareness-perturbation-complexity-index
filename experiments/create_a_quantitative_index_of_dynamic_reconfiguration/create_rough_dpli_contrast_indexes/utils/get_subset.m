function [common_location, common_region] = get_subset(baseline_location, anesthesia_location, recovery_location, baseline_regions, anesthesia_regions, recovery_regions)
