function [common_location, common_region] = get_subset(baseline_location, anesthesia_location, baseline_regions, anesthesia_regions)
% GET SUBSET is a helper function to get the subset of all the regions that
% are common across all three states
% 
% baseline_location, anesthesia_location: are all three
